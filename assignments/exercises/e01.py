...
###############################################################################
x = tf.random_uniform([], dtype=tf.float32)  # Empty array as shape creates a scalar.
y = tf.random_uniform([], dtype=tf.float32)
out = tf.cond(tf.greater(x, y), tf.add(x, y), tf.subtract(x, y))
...
###############################################################################
x = tf.diag(tf.range(start=1, limit=7, delta=1))
